...
HerokuSubdomain.configure do |config|
  ...
  config.heroku = Heroku::API.new(api_key: '197c9196f0c294ceea9c8720b7dc5772', mock: !Rails.application.config.heroku_subdomain_enable)
  config.addons = %w(memcache:5mb mongolab:starter redistogo:nano sendgrid:starter)
  config.vars = [{
